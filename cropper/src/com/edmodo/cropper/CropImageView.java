 ...
 *
 * Copyright 2017, xiong-it(MichaelX)
 *
 ...
 *
 * @MichaelX https://github.com/xiong-it
 * 在cropper基础上优化了裁图体验：
 * 1. 增加最低/最高分辨率限定支持
 * 2. 增加最小/最大宽高比例限定支持
 */
public class CropImageView extends AppCompatImageView {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        mGuidelinesMode = typedArray.getInteger(R.styleable.CropImageView_guidelines, GUIDELINES_ON);
...
//        drawBorder(canvas);
    ...
    /**
     * 给各个指标加上微小的误差，防止float运算造成的极限值不达标。
     */

    public void setMinScale(float minScale) {
        // 防止float运算丢失
        this.minScale = minScale + 0.05f;
    }

    public void setMaxScale(float maxScale) {
        // 防止float运算丢失
        this.maxScale = maxScale - 0.05f;
    }

    public void setMinWidth(float minWidth) {
        // 防止float运算丢失
        this.minWidth = minWidth + 0.5f;
    }

    public void setMinHeight(float minHeight) {
        // 防止float运算丢失
        this.minHeight = minHeight + 0.5f;
    }
